...
const policies: Policy[] = [
  {
    ...
    whyRecommended: "Based on your hypertension condition and preference for preventive care, this plan offers comprehensive coverage with no waiting period for pre-existing conditions.",
  },
  {
    id: "health-2",
    name: "Essential Care",
    ...
    coverage: "$250K",
    features: [
      "Pre-existing conditions covered (6 mo wait)",
  ...
  },
  {
    ...
    whyRecommended: "Given your vehicle's age (6-10 years) and high mileage, comprehensive coverage protects against mechanical failures and accidents.",
  },
  {
    id: "property-1",
    ...
    features: [
      ...
      "Liability coverage",
      "Security system discount applied",
                      ...
                      <div className="flex-1">
                        <div className="flex flex-wrap items-start justify-between gap-4 mb-3">
                          ...
                          <div className="text-right">
                            <div className="text-3xl font-bold text-foreground">${policy.monthlyPremium}</div>
