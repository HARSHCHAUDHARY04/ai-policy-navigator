        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          <div className="flex-1 text-center lg:text-left space-y-10">
            ...
            <motion.div
              ...
              className="pt-8 flex flex-wrap items-center justify-center lg:justify-start gap-x-10 gap-y-4 border-t border-white/5"
            >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-3/4 w-full max-w-[800px] h-[800px] pointer-events-none -z-10 opacity-70">
            <Hero3D />
          </div>
        </div>
      </div>
